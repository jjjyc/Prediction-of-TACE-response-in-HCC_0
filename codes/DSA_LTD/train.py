...
#To continue training from the former model
...
train_img_data = nrgbase +'/train/pre_img'
train_liver_data = nrgbase +'/train/liver_labels_wb'
train_diff_data = nrgbase +'/train/keydiffer3'
train_imgs_data = nrgbase +'/train/img10'
train_label_data = nrgbase +'/train/pre_labels_wb'
...
#====test==
test_img_data = nrgbase +'/test/pre_img'
test_liver_data = nrgbase +'/test/liver_labels_wb'
test_diff_data = nrgbase +'/test/keydiffer3'
test_imgs_data =  nrgbase +'/test/img10'
test_label_data = nrgbase + '/test/pre_labels_wb'
